...
<div class="page">
    ...
    <!-- Intro -->
    <section class="home_intro  parallax2" data-image="img/us2.jpg">
        ...
        <div class="home_txt" data-0="opacity:1" data-top-bottom="opacity:0">
            ...
            <div class="box">
                ...
                <div class="title1"><span>January 19th, 2020</span></div>
            </div>
    ...
    <section class="married clearfix" id="married">
        <div class="container">
            <div class="im1 parallax" data-bottom="left:30%" data-center="left:0" data-image="img/dika1.jpg">
                <div class="im_arrows"></div>
            </div>
            <div class="im2 parallax" data-bottom="right:20%" data-center="right:0" data-image="img/momo2.jpg"
            ...
            <div class="married_txt" data-bottom="opacity:0" data-center="opacity:1">
                ...
                On the 19th of Jan, 2020<br>
                <b> Andika Irawan &amp; Monika Aprilia Handayani</b><br>
                are getting married in Makassar.<br>
    ...
    <!-- Married End -->
    <!-- When & Where -->
    <section class="when_where white_txt parallax" id="when_where" data-image="img/bambuden.png"
        ...
        <div class="container">
            ...
            <div class="when_where_container opacity">
                ...
                <div class="title1">Bambuden III</div>
                <div class="title2">3rd Floor</div>
                <div class="title3"><a class="maplink" href="https://goo.gl/maps/ikD2ARCNUfgCwHSKA" target="_blank">
                ...
                <div class="title4">19 January 2020</div>
    ...
    <section class="our_story events" id="events">
        ...
        <div class="story_wrapper">
            ...
            <div class="story_item">
                <div class="story_img parallax" data-image="img/sangjit.jpg">
                ...
                <div class="story_plane">
                    ...
                    <div class="story_txt">
                        ...
                        Sangjit is lorem ipsum dolor sit amet
                    </div>
                </div>
            </div>
            ...
            <div class="story_item">
                <div class="story_img parallax" data-image="img/girinaga.jpg">
                    <div class="story_img_plane"></div>
                </div>
                <div class="story_plane">
                    <div class="story_back"></div>
                    <div class="story_txt">
                        <div class="story_title">
                            Blessing Ceremony
                            <i>19.01.2020 1PM - 3PM</i>
                        </div>
                        Blessing Ceremony will take place in lorem ipsum dolor sit amet
                    </div>
                </div>
            </div>
                ...
                <div class="paper">
                    ...
                    <div id="div_block_1">
                        ...
                        <p>We’re excited to see you! Any questions, just email us at:
                            <a href="mailto:andika.irone@gmail.com">andika.irone@gmail.com</a></p>
                    </div>
                </div>
    ...
    <section class="footer white_txt parallax" id="footer" data-image="img/footer3.png">
        ...
        <div class="container">
            ...
            <div class="footer_txt">
                ...
                <div class="title1">Andika &amp; Monika</div>
                <!-- Copyrights -->
